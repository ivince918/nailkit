  ...
  return (
    <section id="top" ref={ref} tabIndex={-1} className="campaign-hero" onPointerMove={move} onPointerLeave={() => { ref.current?.style.setProperty('--hero-x', '0px'); ref.current?.style.setProperty('--hero-y', '0px') }}>
      ...
      <div className="campaign-inner">
        ...
        <a className="hero-visit-card hero-enter" href={links.book}><span className="visit-card-top"><span>TODAY</span><ArrowUpRight size={20}/></span><strong>{todayLine}</strong><span className="visit-card-bottom">Walk-ins welcome · Request a time <span>↗</span></span></a>
      </div>
    </section>
  )
}
